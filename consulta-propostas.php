          ...
          <form action="" method="post" class="formulario">
            ...
            <div class="area-resultado">
                ...
                if($consultarTodos){
                    ...
                    $result_servicos = "SELECT * FROM servicos WHERE status_servico LIKE '1'";
                ...
                ?>
                    ...
                    <div class="botoes">
                        ...
                        <?php echo "<a href='sql-deleta-proposta.php?id_servico=". $row_servicos['id_servico'] ."'><input type='submit' class='btn-excluir' value='EXCLUIR' onclick='return confirmaExclusao();'></a>" ?>
                    </div>
                </div>  
                ...
                if($consultarPropostas){
                    ...
                    $result_servicos = "SELECT * FROM servicos WHERE status_servico LIKE '1' AND titulo_servico like '%$titulo_servico%' AND tipo_servico LIKE '%$tipo_servico%'";
                    $resultado_servicos = mysqli_query($conn, $result_servicos);
                ...
                <?php while($row_servicos = mysqli_fetch_assoc($resultado_servicos)){ ?>
                    ...
                    <div class="botoes">
                        <input type="submit" class="btn-visualizar" value="VISUALIZAR">
                        <?php echo "<a href='gerar-pdf.php?id_servico=". $row_servicos['id_servico'] ."' target='_blank'><input type='submit' class='btn-visualizar' value='VISUALIZAR'></a>" ?>
                        <?php echo "<a href='editar-servico.php?id_servico=". $row_servicos['id_servico'] ."'><input type='submit' class='btn-editar' value='EDITAR'></a>" ?>
                        <?php echo "<a href='sql-deleta-proposta.php?id_servico=". $row_servicos['id_servico'] ."'><input type='submit' class='btn-excluir' value='EXCLUIR' onclick='return confirmaExclusao();'></a>" ?>
                    </div>
