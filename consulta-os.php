          ...
          <form action="" method="post" class="formulario">
            ...
            <div class="area-resultado">
                ...
                if($consultarTodos){
                    ...
                    $result_servicos = "SELECT * FROM servicos WHERE status_servico LIKE '2'";
                ...
                ?>
                    ...
                    <div class="botoes">
                        ...
                        <?php echo "<a href='sql-deleta-os.php?id_servico=". $row_servicos['id_servico'] ."'><input type='submit' class='btn-excluir' value='EXCLUIR' onclick='return confirmaExclusao();'></a>" ?>
                    </div>
                </div>  
                ...
                if($consultarPropostas){
                    ...
                    $result_servicos = "SELECT * FROM servicos WHERE status_servico LIKE '2' AND titulo_servico like '%$titulo_servico%' AND tipo_servico LIKE '%$tipo_servico%'";
                    $resultado_servicos = mysqli_query($conn, $result_servicos);
