...
?>
      ...
      <div class="conteudo">
          <h1>NOVA SERVIÇO DE LAUDOS DE SPDA</h1>
          <form action="sql-laudos-spda.php" method="post" class="formulario">
            ...
            <div id="adicionaItem2">
                ...
                <textarea class="input_form_textarea" name="descricaoItem placeholder="Descrição do item"></textarea>
                </div>
            </div>
